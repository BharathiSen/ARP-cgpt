  ...
  return (
    <section className="relative h-screen w-full overflow-hidden flex items-center justify-center pt-20">
      ...
      <div className="absolute inset-0 z-[1]"
           style={{ background: 'linear-gradient(to bottom, rgba(5,7,15,0.35) 0%, rgba(5,7,15,0.55) 100%)' }} />
        ...
        >
          ...
          <div className="ds-badge mb-8">
            <span className="relative flex h-2 w-2">
              ...
              <span className="relative inline-flex rounded-full h-2 w-2" style={{ background: '#00C8FF' }} />
            </span>
            Platform Live v2.0
          </div>

          {/* Headline */}
          <h1 className="text-5xl md:text-7xl font-black tracking-tight text-white mb-6 leading-[1.08]"
              style={{ textShadow: '0 4px 40px rgba(0,0,0,0.7)' }}>
            Test Your API Reliability{' '}
          ...
          <p className="text-lg md:text-xl font-medium max-w-2xl mx-auto mb-10"
             style={{ color: '#9AA6C4', textShadow: '0 2px 20px rgba(0,0,0,0.8)' }}>
            Simulate failures, stress test endpoints, and analyze system behavior
