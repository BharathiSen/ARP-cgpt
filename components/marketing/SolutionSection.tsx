    ...
    <section className="py-32 relative bg-background border-t border-white/5">
       <div className="max-w-7xl mx-auto px-6">
         <div className="text-center mb-20">
           <div className="font-semibold tracking-wider uppercase text-sm mb-4 text-transparent bg-clip-text bg-gradient-to-r from-[#00C8FF] to-[#4DEBFF]">How It Works</div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {steps.map((step, i) => (
              ...
              >
                <div className="text-5xl font-bold text-white/10 mb-6">{step.number}</div>
