      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-lg text-[#9AA6C4] mb-10 max-w-lg">
            Network latency, third-party downtimes, and unexpected traffic
            spikes cause cascading failures in modern microservices. You
            can&apos;t rely on hoping things just work.
          </p>
