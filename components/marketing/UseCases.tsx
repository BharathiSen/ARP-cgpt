...
export default function UseCases() {
  ...
  const handleCardClick = (title: string) => {
    const scenario = encodeURIComponent(
      `Test my ${title} architecture under heavy load`,
    );
      ...
      >
        {cases.map((c, idx) => {
          ...
          return (
            ...
            >
              <div
                className="mb-5 p-3.5 rounded-xl w-fit transition-all duration-300"
                style={{
              ...
              <div
                className="mt-6 flex items-center gap-2 text-[10px] font-bold tracking-widest"
