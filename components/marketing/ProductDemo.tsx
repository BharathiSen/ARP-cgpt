...
export default function ProductDemo() {
  return (
    <section
      id="demo"
      className="py-32 bg-background border-t border-white/5 relative"
    >
              ...
              <div className="space-y-4 relative z-10 flex-1">
                <div className="bg-white/5 p-4 rounded-xl border border-white/10">
                  <p className="text-[#9AA6C4] text-sm leading-relaxed">
                    ...
                    Latency spikes detected above 800ms during peak load at
                    10:15.
                  </p>
                </div>
                <div className="bg-[#00C8FF]/10 p-4 rounded-xl border border-[#00C8FF]/20">
                  <p className="text-[#9AA6C4] text-sm leading-relaxed">
                    ...
                    Consider implementing exponential backoff retries and adding
                    circuit breakers to downstream service requests to prevent
                    resource exhaustion.
                  </p>
                </div>
